 ...
 * 
 * @param {string} ownerKey The private key of the EOA owner 
 * @returns {Promise<{address: string, privateKey: string, clientSetup: object}>}
 */
async function createPermissionlessSCADirectJS(ownerKey) {
